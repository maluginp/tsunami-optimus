...
static const char qt_meta_stringdata_FormSetting[] = {
    "FormSetting\0\0saveSetting()\0openSetting()\0"
};
...
void FormSetting::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        FormSetting *_t = static_cast<FormSetting *>(_o);
        switch (_id) {
...
const QMetaObjectExtraData FormSetting::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject FormSetting::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_FormSetting,
      qt_meta_data_FormSetting, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &FormSetting::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_FormSetting))
        return static_cast<void*>(const_cast< FormSetting*>(this));
